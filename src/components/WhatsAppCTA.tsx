...
const WhatsAppCTA = () => {
  const phoneNumber = "918655312300";
  const message = encodeURIComponent(
    "Hello! I'm interested in Prana Organic Farms vermicompost products. Please share more details."
  );
  ...
  return (
    ...
    >
      ...
      {/* Pulse ring */}
      <div
        className="absolute inset-0 rounded-full animate-ping bg-whatsapp/50 opacity-75"
