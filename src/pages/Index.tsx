...
import { Leaf, Globe, Award, Recycle, ArrowRight, Sparkles } from "lucide-react";
    ...
    <Layout>
        ...
        <div className="container relative z-10 py-20 text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-foreground">Premium Organic Vermicompost</span>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4 glass px-6 py-4 rounded-2xl">
                ...
                >
                  ...
                  <Leaf className="h-12 w-12 text-primary relative z-10" />
                </motion.div>
                <span className="text-3xl md:text-4xl font-bold text-primary">Prana Organic Farms</span>
              </div>
            </motion.div>
            ...
            >
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-8 shadow-lg hover:shadow-xl transition-all hover:scale-105 group">
                <Link to="/product">
                  View Product
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="rounded-full px-8 glass border-primary/30 text-primary hover:bg-primary/10 hover:scale-105 transition-all">
      ...
      <AnimatedSection className="py-24 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <AnimatedHeading className="text-center mb-16">
            ...
            <AnimatedText delay={0.2} className="text-muted-foreground max-w-2xl mx-auto text-lg">
      ...
      <AnimatedSection className="py-24 relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          >
            <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground rounded-full px-10 shadow-2xl hover:shadow-accent/25 hover:scale-105 transition-all group">
              <Link to="/contact">
                Get in Touch
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Link>
